    ...
    onCreatePassword=(value)=>{
        ...
        .then (({data})=>{
            ...
            if(data.status === 'success')
            {
                ...
                const userObj = {"user_id":data.data.id,"user_type":data.data.usertype_id,"name":data.data.fullname,"email":data.data.email,"phone":data.data.phone_number,"ref_code":data.data.referred_code};
    ...
    onDoLogin=(value)=>{
         ...
         .then (({data})=>{
             ...
             if(data.status === 'success')
            {
                ...
                const userObj = {"user_id":data.data.user_id,"user_type":data.data.user_type.id,"name":data.data.name,"email":data.data.email,"phone":data.data.phone_number,"ref_code":data.data.ref_code};
                swal ( "Success" ,  "Welcome to Osiso" ,  "success" );
                sessionStorage.setItem('userData',JSON.stringify(userObj));
                this.setState({
                    isAuth: true,
