...
class Info extends Component {
    constructor(props) {
        ...
        const parcel = sessionStorage.getItem("parcel") ? JSON.parse(sessionStorage.getItem("parcel")) : {};       
        if (!sessionStorage.getItem("from_menu")) {
            this.state = {
                data: parcel,
                isParcel: true,
                parcelData:{},
        ...
        if(sessionStorage.getItem('schedule_datetime'))
        {
            this.state.data.pickup_date = JSON.parse(sessionStorage.getItem('schedule_datetime')).sDate;
            this.state.data.pickup_time = JSON.parse(sessionStorage.getItem('schedule_datetime')).sTime;  
            //sessionStorage.removeItem('schedule_datetime'); 
        }
        sessionStorage.removeItem('from_menu');
    }
    onChange=(e)=>{  
    ...
    onParcel=(value)=>{
        ...
        //console.log('parcel',this.state.data)
    ...
    onSubmit=()=>{
        ...
        if (pickup_point !== '' && pickup_date !== '' && isParcel === true && receiver_fname !== '' && receiver_lname !== '' && receiver_phone !== '' && sender_fname !== '' && sender_lname !== '' && sender_email !== '' && sender_phone !== '' && pickup_time !== '' && user_type_id !== '') {
            this.props.step(2);
            ...
            this.props.history.push('schedule/review');
        }
        else if(!isParcel)
        {
